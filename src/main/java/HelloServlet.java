...
// /hs URL에 연결
@WebServlet(name="MyFirstServlet", urlPatterns="/hs", initParams= {@WebInitParam(name="servletName", value="HelloServlet"), @WebInitParam(name="description", value="나의 첫 번째 서블릿입니다.")})
